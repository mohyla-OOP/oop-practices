# 01 InheritedStack Class Diagram
...
classDiagram
    ...
    ArrayStack~Elem~ <|-- Stack~T,Implementation~
    Stack~T,Implementation~ ..> ArrayStack~Elem~ : uses
    Stack~T,Implementation~ ..> ListStack~Elem~ : uses
