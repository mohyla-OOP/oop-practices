...
NoCopyNoAssignNoHeap::~NoCopyNoAssignNoHeap() { cout << "NoCopyNoAssignNoHeap deleted (" << this << ':' << _c << ',' << _i << ',' << ')' << endl; }
...
NoCopyNoHeap::~NoCopyNoHeap() { cout << "NoCopyNoHeap deleted (" << this << ':' << _c << ',' << _i << ',' << ')' << endl; }
...
NoHeap::NoHeap(char c, int i) : _c(c), _i(i) { cout << "NoHeap created (" << this << ':' << _c << ',' << _i << ',' << ')' << endl; };

NoHeap::NoHeap(const NoHeap &t) : _c(t._c), _i(t._i) { cout << "NoHeap created (" << this << ':' << _c << ',' << _i << ',' << ')' << endl; };

NoHeap::~NoHeap() { cout << "NoCopyNoHeap deleted (" << this << ':' << _c << ',' << _i << ',' << ')' << endl; }
