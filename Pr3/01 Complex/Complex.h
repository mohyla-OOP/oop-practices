...
{
  // Insider
  friend Complex operator+(const Complex &a, const Complex &b) { return {a._re + b._re, a._im + b._im}; }
  friend std::ostream &operator<<(std::ostream &os, const Complex &a) { return os << '(' << a._re << ',' << a._im << ')'; }
 ...
 public:
  ...
  Complex() {};
  Complex operator+(this const Complex &a, const Complex &b) { return {a._re + b._re, a._im + b._im}; }
...
{
  // Insider
  friend std::ostream &operator<<(std::ostream &os, const TComplex &a) { return os << '(' << a._r << ',' << a._phi << ')'; }
