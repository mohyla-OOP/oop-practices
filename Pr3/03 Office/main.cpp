...
int main()
{
  ...
  // Data base personnel
  Person personnel[npersonnel] = {Person("Wano"), Person("Dick"), Person("Lee"), Person("Pete"), Person("Bob"), Person("Joe"), Person("Jane")};
  ...
  Position establishment[nestablishement] = {Position("Analyst", 1000), Position("Coder", 800), Position("Tester", 900)};

  for (int i = 0; i < npersonnel; i++) cout << personnel[i].getName() << endl;
  for (int i = 0; i < nestablishement; i++) cout << establishment[i].getPositionName() << endl;
