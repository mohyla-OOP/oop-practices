...
Composite h() { return std::move(Composite()); }
...
CopyOnly fCopyOnly() { return CopyOnly(); }
...
NoMove g(const NoMove &a) { return a; }
NoMove h(NoMove a) { return g(a); }
