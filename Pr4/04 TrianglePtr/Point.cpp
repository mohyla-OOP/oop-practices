...
Point::Point(double x, double y) : _x(x), _y(y), myId(++freeID)
{
  ++_call;
#ifndef NDEBUG
...
Point::Point(const Point &u) : _x(u._x), _y(u._y), myId(++freeID)
{
  ++_call;
#ifndef NDEBUG
...
bool operator!=(const Point &u, const Point &v) { return !(u == v); }
