...
Triangle::Triangle(const Triangle &t, const bool full) : _a(t._a), _b(t._b), _c(t._c), _ab(0), _bc(0), _ca(0)
{
  ++_call;
  if (full)
  {
...
ostream &operator<<(ostream &os, const Triangle &t) { return t.show(os); }