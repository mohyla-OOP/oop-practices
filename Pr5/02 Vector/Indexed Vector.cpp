...
IndexedWrappedVector::IndexedWrappedVector() : _v(new double[_n]) { fill(*this); }

IndexedWrappedVector::IndexedWrappedVector(const IndexedWrappedVector &vec) : _v(new double[_n])
{
...
bool operator!=(const IndexedWrappedVector &u, const IndexedWrappedVector &v) { return !(u == v); }
