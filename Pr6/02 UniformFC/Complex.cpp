...
Complex::Complex(double re, double im) : _re(re), _im(im) { return; }

Complex::Complex(const Complex &c) : _re(c.re()), _im(c.im()) { return; }

Complex::~Complex() { return; }
...
double &Complex::re() { return _re; }
double &Complex::im() { return _im; }
