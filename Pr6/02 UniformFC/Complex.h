...
class Complex
{
 ...
 public:
  ...
  static Coord getre() { return &Complex::_re; }

  static Coord getim() { return &Complex::_im; }
  Complex &operator+=(const Complex &);
  Complex &operator-=(const Complex &);
  Complex &operator*=(const Complex &);
  Complex &operator/=(const Complex &);
...
double Complex::select(ConstCoord u) const { return this->*u; }
void Complex::modify(Coord u, double a) { this->*u = a; }
...
class Adapter
{
 ...
 public:
  ...
  T &operator()(T &a, const T &b) { return (a.*_pmf)(b); }
};
